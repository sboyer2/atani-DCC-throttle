...
MenuComponent::MenuComponent(STRING_TYPE name)
: _name(name)
{
}

STRING_TYPE MenuComponent::get_name() const
{
    return _name;
}

void MenuComponent::set_name(STRING_TYPE name)
{
    _name = name;
}
...
MenuItem::MenuItem(STRING_TYPE name)
: MenuComponent(name),
  _on_select(0)
{
}
